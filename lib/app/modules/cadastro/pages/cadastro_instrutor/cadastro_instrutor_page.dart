...
class CadastroInstructorPage extends StatefulWidget {
  final String title;
  const CadastroInstructorPage({Key? key, this.title = 'CadastroInstructorPage'}) : super(key: key);
  @override
  CadastroInstructorPageState createState() => CadastroInstructorPageState();
}

class CadastroInstructorPageState extends ModularState<CadastroInstructorPage, CadastroInstrutorStore> {
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: altura * 0.01),
                    InputTextForm(
                      controller: controller.confefController,
                      keyboardType: TextInputType.none,
                      icon: Icon(Icons.calendar_today, color: Colors.transparent, size: 35),
                      hintText: 'CONFEF',
                    ),
                    SizedBox(height: altura * 0.01),
                    InputTextForm(
